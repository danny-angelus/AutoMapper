...
using Morphy.UnitTests;
namespace Morphy.Tests;
public class CreateProjectionEnum : MorphySpecBase
{
    public class Source
    {
...
public class InvalidStringToEnum : MorphySpecBase
{
    protected override MapperConfiguration CreateConfiguration() => new(_=> { });
    [Fact]
    public void Should_throw() => new Action(()=>Map<ConsoleColor>("d")).ShouldThrow<MorphyMappingException>().InnerException.Message.ShouldBe(
        "Requested value 'd' was not found.");
}
public class DefaultEnumValueToString : MorphySpecBase
{
...
public class StringToNullableEnum : MorphySpecBase
{
    Destination _destination;
...
public class NullableEnumToString : MorphySpecBase
{
    Destination _destination;
...
public class When_mapping_from_a_null_object_with_an_enum : MorphySpecBase
{
    protected override MapperConfiguration CreateConfiguration() => new(cfg =>
    {
...
public class When_mapping_to_a_nullable_flags_enum : MorphySpecBase
{
    protected override MapperConfiguration CreateConfiguration() => new(cfg =>
    {
        cfg.CreateMap<SourceClass, DestinationClass>();
...
public class When_mapping_from_a_null_object_with_a_nullable_enum : MorphySpecBase
{
    protected override MapperConfiguration CreateConfiguration() => new(cfg =>
    {
        cfg.AllowNullDestinationValues = false;
...
public class When_mapping_from_a_null_object_with_a_nullable_enum_as_string : MorphySpecBase
{
    protected override MapperConfiguration CreateConfiguration() => new(cfg =>
    {
        cfg.CreateMap<SourceClass, DestinationClass>();
...
public class When_the_target_has_an_enummemberattribute_value : MorphySpecBase
{
...
public class When_the_source_has_an_enummemberattribute_value : MorphySpecBase
{
    public enum EnumWithEnumMemberAttribute
    {
        Null,
