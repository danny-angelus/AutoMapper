...
public class ForPathGenericsSource : MorphySpecBase
{
    class Source<T>
    {
...
public class ForPathGenerics : MorphySpecBase
{
    class Source<T>
    {
        public InnerSource Inner;
...
public class ReadonlyPropertiesGenerics : MorphySpecBase
{
    class Source
    {
        public InnerSource Inner;
...
public class ConstructorValidationGenerics : NonValidatingSpecBase
{
    ...
    {
        var error = new Action(AssertConfigurationIsValid).ShouldThrow<MorphyConfigurationException>().Errors.Single();
        error.CanConstruct.ShouldBeFalse();
        error.UnmappedPropertyNames.Single().ShouldBe("OtherValue");
    }
}
public class SealGenerics : MorphySpecBase
{
...
public class OpenGenerics_With_Struct : MorphySpecBase
{
    public struct Id<T>
    {
    }
...
public class OpenGenerics_With_Base_Generic : MorphySpecBase
{
    public class Foo<T>
    {
...
public class GenericMapsAsNonGeneric : MorphySpecBase
{
    class Source
    {
        public int Value;
...
public class GenericMapsPriority : MorphySpecBase
{
    class Source<T>
    {
        public T Value;
...
public class GenericMapWithUntypedMap : MorphySpecBase
{
    class Source<T>
    {
        public T Value;
...
public class GenericValueResolverTypeMismatch : MorphySpecBase
{
    class Source<T>
    {
        public T Value;
...
public class GenericValueResolver : MorphySpecBase
{
    class Destination
    {
        public string MyKey;
...
public class GenericMemberValueResolver : MorphySpecBase
{
    class Destination
    {
        public string MyKey;
...
public class RecursiveOpenGenerics : MorphySpecBase
{
...
public class OpenGenericsValidation : NonValidatingSpecBase
{
    ...
    public void Should_report_unmapped_property()
    {
        new Action(Configuration.AssertConfigurationIsValid)
            .ShouldThrow<MorphyConfigurationException>()
...
public class OpenGenericsProfileValidation : MorphySpecBase
{
    public class Source<T>
    {
        public T[] Value { get; set; }
...
public class OpenGenerics_With_MemberConfiguration : MorphySpecBase
{
    public class Foo<T>
    {
        public int A { get; set; }
...
public class OpenGenerics_With_UntypedMapFrom : MorphySpecBase
{
    public class Foo<T>
    {
        public T Value1 { get; set; }
...
public class OpenGenerics_With_UntypedMapFromStructs : MorphySpecBase
{
