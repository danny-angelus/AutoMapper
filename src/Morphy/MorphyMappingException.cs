...
/// </summary>
public class MorphyMappingException : Exception
{
    private readonly string _message;

    public MorphyMappingException()
    {
    }

    public MorphyMappingException(string message)
        : base(message) => _message = message;

    public MorphyMappingException(string message, Exception innerException)
        : base(message, innerException) => _message = message;

    public MorphyMappingException(string message, Exception innerException, TypePair types)
        : this(message, innerException) => Types = types;

    public MorphyMappingException(string message, Exception innerException, TypeMap typeMap)
        : this(message, innerException, typeMap.Types) => TypeMap = typeMap;

    public MorphyMappingException(string message, Exception innerException, MemberMap memberMap)
        ...
        get
        {
            return string.Join(Environment.NewLine,
                base.StackTrace
                    ...
                    .Where(str => !str.TrimStart().StartsWith("at Morphy.")));
        }
    }
#endif
}
...
public class MorphyConfigurationException : Exception
{
    ...
    public MorphyConfigurationException(string message)
        : base(message)
    {
    }

    public MorphyConfigurationException(string message, Exception inner)
        : base(message, inner)
    {
    }

    public MorphyConfigurationException(TypeMapConfigErrors[] errors) => Errors = errors;

    public MorphyConfigurationException(TypePair types) => Types = types;
    ...
    public override string Message
    {
        get
        {
            if (Types.HasValue)
            {
                ...
                while (exToUse != null)
                {
                    if (exToUse is MorphyConfigurationException configExc)
                    {
